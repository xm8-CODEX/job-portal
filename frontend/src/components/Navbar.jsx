        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            ...
            <div className="flex flex-col">
              <span className="text-lg font-bold tracking-tight bg-gradient-to-r from-indigo-600 via-indigo-700 to-indigo-900 bg-clip-text text-transparent">
                NaukriSetu
              </span>
              <span className="text-[10px] font-medium text-slate-500 -mt-1 tracking-wider">
                {i18n.language?.startsWith('hi') ? 'नौकरीसेतु' : i18n.language?.startsWith('mr') ? 'नोकरीसेतू' : 'Job Portal'}
              </span>
            </div>
          </Link>
